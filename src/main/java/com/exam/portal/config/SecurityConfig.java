...
public class SecurityConfig  {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(
                request -> request
                        .requestMatchers(
				        "/webjars/**","/img/**","/video/**","/js/**","/webfonts/**","/css/**" , "/","/trainee_signup","/sign-up.html","/sign-up-trainee.html","/contact.html","/exam","/goto/exam","/courses-details.html","/organiser/organization/register","/trainee_sign_up").permitAll()
